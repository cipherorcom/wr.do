...
| CLOUDFLARE_ACCOUNT_ID | `123465` | The zone ID for Cloudflare. |
| CLOUDFLARE_GLOBAL_KEY | `123465` | The API key for Cloudflare. |
...
> `NEXT_PUBLIC_SHORT_DOMAINS` is used to limit the short domain name and email domain name.
...
- How to get `CLOUDFLARE_ACCOUNT_ID`、`CLOUDFLARE_GLOBAL_KEY`、`CLOUDFLARE_EMAIL`, see [Cloudflare Configs](/docs/developer/cloudflare).
